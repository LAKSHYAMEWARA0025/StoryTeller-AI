...
import StoryFormatViewer from '../../../components/StoryFormatViewer';
...
export default function GeneratePage() {
  ...
  const [storyData, setStoryData] = useState<StoryGenerateResponse | null>(null);
          ...
          >
            <div className="text-center">
              ...
              <p className="text-slate-400 text-sm">
                {isInteractiveFormat(storyData.format)
                  ? 'Use the arrows to navigate through your comic.'
                  : 'Scroll through your static comic and download any panel.'}
              </p>
            </div>
            <StoryFormatViewer
              panels={storyData.panels}
              title={(storyData as any).title || 'Generated Comic'}
